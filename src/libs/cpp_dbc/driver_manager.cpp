...
namespace cpp_dbc
{
                                                             ...
                                                             const std::string &password)
    {
        ...
        // URL format: cppdbc:driverName://host:port/database
        size_t prefixPos = url.find("cppdbc:");
        if (prefixPos != 0)
        {
            throw SQLException("Invalid URL format. Expected cppdbc:driverName://host:port/database");
        }
