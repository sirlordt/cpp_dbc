...
namespace cpp_dbc::ScyllaDB
{
    ...
    private:
        ...
        // Private nothrow constructor: contains all initialization logic.
        // Never throws — create(std::nothrow_t) is the only entry point.
        ScyllaDBPreparedStatement(std::nothrow_t,
