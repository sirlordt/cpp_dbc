 ...
 *
 * @file 22_061_example_sqlite_blob.cpp
 * @brief SQLite-specific example demonstrating BLOB operations
 *
 ...
 *
 * Usage:
 *   ./22_061_example_sqlite_blob [--config=<path>] [--db=<name>] [--help]
 *
 * Exit codes:
 *   0   - Success
 *   1   - Runtime error
...
// Function to run all BLOB demonstrations for SQLite
...
int main(int argc, char *argv[])
{
    ...
    if (args.showHelp)
    {
        printHelp("22_061_example_sqlite_blob", "sqlite");
        return EXIT_OK_;
    }
