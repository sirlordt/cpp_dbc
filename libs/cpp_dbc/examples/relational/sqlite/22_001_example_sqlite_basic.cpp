 ...
 *
 * @file 22_001_example_sqlite_basic.cpp
 * @brief SQLite-specific example demonstrating basic CRUD operations
 *
 ...
 *
 * Usage:
 *   ./22_001_example_sqlite_basic [--config=<path>] [--db=<name>] [--help]
 *
 * Exit codes:
 *   0   - Success
 *   1   - Runtime error
...
#else
    // Run the example with SQLite-specific operations
