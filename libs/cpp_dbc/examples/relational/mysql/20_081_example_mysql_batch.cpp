 ...
 *
 * @file 20_081_example_mysql_batch.cpp
 * @brief MySQL-specific example demonstrating batch operations
 *
 ...
 *
 * Usage:
 *   ./20_081_example_mysql_batch [--config=<path>] [--db=<name>] [--help]
 *
 * Exit codes:
 *   0   - Success
 *   1   - Runtime error
...
{
    logMsg("========================================");
    logMsg("cpp_dbc MySQL Batch Operations Example");
    logMsg("========================================");
    logMsg("");
    ...
    if (args.showHelp)
    {
        printHelp("20_081_example_mysql_batch", "mysql");
        return EXIT_OK_;
    }
