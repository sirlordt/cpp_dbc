 ...
 *
 * @file 21_071_example_postgresql_join.cpp
 * @brief PostgreSQL-specific example demonstrating SQL JOIN operations
 *
 ...
 *
 * Usage:
 *   ./21_071_example_postgresql_join [--config=<path>] [--db=<name>] [--help]
 *
 * Exit codes:
 *   0   - Success
 *   1   - Runtime error
...
int main(int argc, char *argv[])
{
    ...
    if (args.showHelp)
    {
        printHelp("21_071_example_postgresql_join", "postgresql");
        return EXIT_OK_;
    }
