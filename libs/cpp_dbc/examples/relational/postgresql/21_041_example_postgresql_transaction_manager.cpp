 ...
 *
 * @file 21_041_example_postgresql_transaction_manager.cpp
 * @brief PostgreSQL-specific example demonstrating transaction management across threads
 *
 * This example demonstrates:
 * - Transaction management with PostgreSQL connection pools
 * - Multi-threaded workflow processing
 * - Transaction commit and rollback
 *
 * Usage:
 *   ./21_041_example_postgresql_transaction_manager [--config=<path>] [--db=<name>] [--help]
 *
 * Exit codes:
 *   0   - Success
 *   1   - Runtime error
...
int main(int argc, char *argv[])
{
    ...
    if (args.showHelp)
    {
        printHelp("21_041_example_postgresql_transaction_manager", "postgresql");
        return EXIT_OK_;
    }
    ...
    try
    {
        ...
        logOk("PostgreSQL driver registered");
