 ...
 *
 * @file 21_061_example_postgresql_blob.cpp
 * @brief PostgreSQL-specific example demonstrating BLOB (bytea) operations
 *
 ...
 *
 * Usage:
 *   ./21_061_example_postgresql_blob [--config=<path>] [--db=<name>] [--help]
 *
 * Exit codes:
 *   0   - Success
 *   1   - Runtime error
...
// Function to run all BLOB demonstrations for PostgreSQL
...
int main(int argc, char *argv[])
{
    ...
    if (args.showHelp)
    {
        printHelp("21_061_example_postgresql_blob", "postgresql");
        return EXIT_OK_;
    }
