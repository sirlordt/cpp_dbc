...
// These are used in FirebirdDBConnection instead of plain DB_DRIVER_LOCK_GUARD
...
// ============================================================================
// FirebirdConnectionLock - RAII Helper for PreparedStatement and ResultSet
// ============================================================================
...
namespace cpp_dbc::Firebird
{
    ...
    /**
     * @brief RAII lock helper that obtains mutex through weak_ptr<FirebirdDBConnection>
     *
