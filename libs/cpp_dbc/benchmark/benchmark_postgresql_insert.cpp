...
static void BM_PostgreSQL_Insert_Small_Individual(benchmark::State &state)
{
    const std::string tableName = "benchmark_postgresql_insert_small_ind";
    ...
    auto conn = postgresql_benchmark_helpers::setupPostgreSQLConnection(tableName);
...
BENCHMARK(BM_PostgreSQL_Insert_Small_Individual);

static void BM_PostgreSQL_Insert_Small_Prepared(benchmark::State &state)
{
    const std::string tableName = "benchmark_postgresql_insert_small_prep";
...
BENCHMARK(BM_PostgreSQL_Insert_Small_Prepared);

// Medium dataset (100 rows)
static void BM_PostgreSQL_Insert_Medium_Individual(benchmark::State &state)
{
    const std::string tableName = "benchmark_postgresql_insert_medium_ind";
    // Setup phase - outside of measurement
...
BENCHMARK(BM_PostgreSQL_Insert_Medium_Individual);

static void BM_PostgreSQL_Insert_Medium_Prepared(benchmark::State &state)
{
    const std::string tableName = "benchmark_postgresql_insert_medium_prep";
...
BENCHMARK(BM_PostgreSQL_Insert_Medium_Prepared);

// Large dataset (1000 rows)
static void BM_PostgreSQL_Insert_Large_Individual(benchmark::State &state)
{
    const std::string tableName = "benchmark_postgresql_insert_large_ind";
    // Setup phase - outside of measurement
...
BENCHMARK(BM_PostgreSQL_Insert_Large_Individual);

static void BM_PostgreSQL_Insert_Large_Prepared(benchmark::State &state)
{
    const std::string tableName = "benchmark_postgresql_insert_large_prep";
...
BENCHMARK(BM_PostgreSQL_Insert_Large_Prepared);

// XLarge dataset (10000 rows)
static void BM_PostgreSQL_Insert_XLarge_Individual(benchmark::State &state)
{
    const std::string tableName = "benchmark_postgresql_insert_xlarge_ind";
...
BENCHMARK(BM_PostgreSQL_Insert_XLarge_Individual);

static void BM_PostgreSQL_Insert_XLarge_Prepared(benchmark::State &state)
{
    const std::string tableName = "benchmark_postgresql_insert_xlarge_prep";
...
BENCHMARK(BM_PostgreSQL_Insert_XLarge_Prepared);

#else
// Register empty benchmark when PostgreSQL is disabled
static void BM_PostgreSQL_Insert_Disabled(benchmark::State &state)
{
    for (auto _ : state)
    {
...
BENCHMARK(BM_PostgreSQL_Insert_Disabled);
#endif