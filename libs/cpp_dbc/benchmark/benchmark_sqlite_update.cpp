...
// Helper function to setup SQLite connection is moved to sqlite_benchmark_helpers namespace
// in benchmark_common.hpp/cpp for consistency

// Small dataset (10 rows)
static void BM_SQLite_Update_Small_Individual(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_small_ind";
    ...
    // common_benchmark_helpers::logWithTimestampInfo("Benchmark complete. Cleaning up table '" + tableName + "'...");
...
BENCHMARK(BM_SQLite_Update_Small_Individual);

static void BM_SQLite_Update_Small_Prepared(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_small_prep";
...
BENCHMARK(BM_SQLite_Update_Small_Prepared);

// Commented out because all benchmarks are transactional
/*
static void BM_SQLite_Update_Small_Transaction(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_small_trans";
...
BENCHMARK(BM_SQLite_Update_Small_Transaction);
*/

// Medium dataset (100 rows)
static void BM_SQLite_Update_Medium_Individual(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_medium_ind";
...
BENCHMARK(BM_SQLite_Update_Medium_Individual);

static void BM_SQLite_Update_Medium_Prepared(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_medium_prep";
...
BENCHMARK(BM_SQLite_Update_Medium_Prepared);

// Commented out because all benchmarks are transactional
/*
static void BM_SQLite_Update_Medium_Transaction(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_medium_trans";
...
BENCHMARK(BM_SQLite_Update_Medium_Transaction);
*/

// Large dataset (1000 rows)
static void BM_SQLite_Update_Large_Individual(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_large_ind";
...
BENCHMARK(BM_SQLite_Update_Large_Individual);

static void BM_SQLite_Update_Large_Prepared(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_large_prep";
...
BENCHMARK(BM_SQLite_Update_Large_Prepared);

// Commented out because all benchmarks are transactional
/*
static void BM_SQLite_Update_Large_Transaction(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_large_trans";
...
BENCHMARK(BM_SQLite_Update_Large_Transaction);
*/

// Extra Large dataset (10000 rows) - only prepared statement and transaction for better performance
static void BM_SQLite_Update_XLarge_Prepared(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_xlarge_prep";
...
BENCHMARK(BM_SQLite_Update_XLarge_Prepared);

// Commented out because all benchmarks are transactional
/*
static void BM_SQLite_Update_XLarge_Transaction(benchmark::State &state)
{
    const std::string tableName = "benchmark_sqlite_update_xlarge_trans";
...
BENCHMARK(BM_SQLite_Update_XLarge_Transaction);
*/

#else
// Register empty benchmark when SQLite is disabled
static void BM_SQLite_Update_Disabled(benchmark::State &state)
{
    for (auto _ : state)
    {
...
BENCHMARK(BM_SQLite_Update_Disabled);
#endif