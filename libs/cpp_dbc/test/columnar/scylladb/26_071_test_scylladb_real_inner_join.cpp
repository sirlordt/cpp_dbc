...
TEST_CASE("ScyllaDB INNER JOIN emulation", "[26_071_01_scylladb_real_inner_join]")
{
...
#else
TEST_CASE("ScyllaDB INNER JOIN emulation (skipped)", "[26_071_02_scylladb_real_inner_join]")
{
