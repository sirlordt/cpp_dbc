...
TEST_CASE("Firebird JSON data storage", "[23_051_01_firebird_real_json]")
{
    ...
    SECTION("JSON performance with large datasets")
    {
        ...
        cpp_dbc::system_utils::logWithTimesMillis("TEST", "Firebird JSON text search execution time: " + std::to_string(duration) + " ms");
