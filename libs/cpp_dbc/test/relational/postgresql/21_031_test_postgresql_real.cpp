...
TEST_CASE("Real PostgreSQL connection tests", "[21_031_01_postgresql_real]")
{
    ...
    // Transaction management tests moved to 21_141_test_postgresql_real_connection_pool.cpp
    ...
    /* SECTION("PostgreSQL stress test") - moved to 21_141_test_postgresql_real_connection_pool.cpp
    {
        ...
        cpp_dbc::system_utils::logWithTimesMillis("TEST", "PostgreSQL stress test completed in " + std::to_string(duration) + " ms");
...
TEST_CASE("Real PostgreSQL connection tests (skipped)", "[21_031_02_postgresql_real]")
{
