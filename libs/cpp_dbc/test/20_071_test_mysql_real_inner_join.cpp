 ...
 * See the LICENSE.md file in the project root for more information.
 ...
 @file 20_071_test_mysql_real_inner_join.cpp
...
#if USE_MYSQL
// Test case for MySQL INNER JOIN operations
TEST_CASE("MySQL INNER JOIN operations", "[20_071_01_mysql_real_inner_join]")
{
    ...
    SECTION("INNER JOIN with WHERE clause")
    {
        ...
        // The query filters for customers with credit_limit > 2000 AND products with price > 300
