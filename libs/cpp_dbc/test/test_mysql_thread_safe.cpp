 ...
 * See the LICENSE.md file in the project root for more information.
 ...
 @file test_mysql_thread_safe.cpp
 ...
 * and statement state.
 */
TEST_CASE("MySQL Thread-Safety Tests", "[mysql_thread_safe]")
{
...
#else
TEST_CASE("MySQL Thread-Safety Tests (skipped)", "[mysql_thread_safe]")
{
...
#include <catch2/catch_test_macros.hpp>
TEST_CASE("MySQL Thread-Safety Tests (disabled)", "[mysql_thread_safe]")
{
