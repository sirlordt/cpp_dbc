 ...
 * See the LICENSE.md file in the project root for more information.
 ...
 @file 25_071_test_mongodb_real_inner_join.cpp
 @brief Tests for MongoDB INNER JOIN operations using aggregation pipelines
...
#if USE_MONGODB
// Test case for MongoDB INNER JOIN operations
TEST_CASE("MongoDB INNER JOIN operations", "[25_071_01_mongodb_real_inner_join]")
{
    ...
    SECTION("Inner Join with $lookup")
    {
...
TEST_CASE("MongoDB INNER JOIN operations (skipped)", "[25_071_02_mongodb_real_inner_join]")
{
