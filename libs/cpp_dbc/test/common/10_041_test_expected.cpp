...
TEST_CASE("expected<T, E> - Basic construction with value", "[10_041_01_expected]")
{
...
TEST_CASE("expected<T, E> - Construction with error", "[10_041_02_expected]")
{
...
TEST_CASE("expected<T, E> - Value access", "[10_041_03_expected]")
{
...
TEST_CASE("expected<T, E> - Error access", "[10_041_04_expected]")
{
...
TEST_CASE("expected<T, E> - value_or", "[10_041_05_expected]")
{
    SECTION("Has value")
    {
        expected<int, std::string> ex = 42;
...
TEST_CASE("expected<T, E> - Copy semantics", "[10_041_06_expected]")
{
    SECTION("Copy value")
    {
...
TEST_CASE("expected<T, E> - Move semantics", "[10_041_07_expected]")
{
    SECTION("Move value")
    {
...
TEST_CASE("expected<T, E> - Move-only types", "[10_041_08_expected]")
{
...
TEST_CASE("expected<void, E> - Basic construction", "[10_041_09_expected]")
{
...
TEST_CASE("expected<void, E> - Value access", "[10_041_10_expected]")
{
...
TEST_CASE("expected with DBException - Typical usage", "[10_041_11_expected]")
{
...
TEST_CASE("expected<void, DBException> - Typical usage", "[10_041_12_expected]")
{
...
TEST_CASE("expected - Complex types", "[10_041_13_expected]")
{
...
TEST_CASE("expected - Database simulation", "[10_041_14_expected]")
{
    struct Connection
    {
        int id;
...
TEST_CASE("expected<void, E> - Transaction simulation", "[10_041_15_expected]")
{
...
TEST_CASE("expected - Size and alignment", "[10_041_16_expected]")
{
