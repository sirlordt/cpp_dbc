 ...
 * See the LICENSE.md file in the project root for more information.
 ...
 @file test_firebird_real_common.hpp
 @brief Common helpers for Firebird database tests
...
namespace firebird_test_helpers
{
    ...
    /**
     * @brief Get Firebird database configuration with test queries
     *
     * Gets a DatabaseConfig object with Firebird connection parameters either from:
     ...
     * @return cpp_dbc::config::DatabaseConfig with Firebird connection parameters and test queries
     */
    ...
    /**
     * @brief Helper function to check if we can connect to Firebird
     */
