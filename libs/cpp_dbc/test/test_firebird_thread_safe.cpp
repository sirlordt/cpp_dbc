 ...
 * See the LICENSE.md file in the project root for more information.
 ...
 @file test_firebird_thread_safe.cpp
 ...
 * and statement state.
 */
TEST_CASE("Firebird Thread-Safety Tests", "[firebird_thread_safe]")
{
...
#else
TEST_CASE("Firebird Thread-Safety Tests (skipped)", "[firebird_thread_safe]")
{
...
#include <catch2/catch_test_macros.hpp>
TEST_CASE("Firebird Thread-Safety Tests (disabled)", "[firebird_thread_safe]")
{
