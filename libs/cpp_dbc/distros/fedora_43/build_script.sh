...
if [ "__DEBUG_SERIAL_QUEUE__" = "ON" ]; then
    DEBUG_SERIAL_QUEUE_PARAM="--debug-serial-queue"
fi
...
sed -i "s/@USE_SCYLLADB@/__USE_SCYLLADB__/g" /tmp/${PACKAGE_NAME}/usr/lib/cmake/cpp_dbc/cpp_dbc-config.cmake
